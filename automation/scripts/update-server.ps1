...
$result = Update-GameServerDedicatedServer -Game $Game -Settings $settings -WhatIf:$WhatIfPreference
Write-CKInfo "$($settings['displayName']) Dedicated Server update completed with exit code $($result.ExitCode)."
